...
description: Classify a Jira ticket against the ATD lite-eligibility table and create the change with the confirmed schema (atd-sdlc or atd-sdlc-lite). Use when starting work on a Jira ticket.
...
Classify a Jira ticket as lite or full and create the change with the confirmed schema.
