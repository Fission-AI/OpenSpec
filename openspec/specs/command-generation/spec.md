...
## Purpose
Define tool-agnostic command content and adapter contracts for generating tool-specific Pastelsdd command files.
...
- **THEN** `CommandContent` SHALL include:
  ...
  - `name`: human-readable name (e.g., 'Pastelsdd Explore')
  - `description`: brief description of command purpose
  - `category`: grouping category (e.g., 'Pastelsdd')
...
- **WHEN** generating all pastel commands for a tool
