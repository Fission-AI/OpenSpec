# i18n-validator-keywords Specification

## Purpose
Define multi-language support for normative keyword validation, enabling the validator to accept RFC 2119 keywords in all supported languages using a centralized keyword registry.
