...
- Marked `pastelsdd/changes/workspace-reimplementation-roadmap/START_HERE.md` as historical reference.
- Marked `pastelsdd/changes/workspace-reimplementation-roadmap/HISTORICAL_DIRECTION.md` as historical reference.
- Marked `pastelsdd/changes/workspace-reimplementation-roadmap/` as historical
  reference.
...
- `pastelsdd validate workspace-reimplementation-roadmap --no-interactive`,
  `pastelsdd validate workspace-apply-repo-slice --no-interactive`, and
  `pastelsdd validate workspace-verify-and-archive --no-interactive` failed
...
- `pastelsdd/changes/workspace-reimplementation-roadmap/START_HERE.md`
- `pastelsdd/changes/workspace-reimplementation-roadmap/HISTORICAL_DIRECTION.md`
- `pastelsdd/changes/workspace-reimplementation-roadmap/README.md`
- `pastelsdd/changes/workspace-reimplementation-roadmap/proposal.md`
- `pastelsdd/changes/workspace-reimplementation-roadmap/POC_REFERENCE_GUIDE.md`

Added a guard near the top of
`pastelsdd/changes/workspace-reimplementation-roadmap/HISTORICAL_DIRECTION.md` stating
...
- No files under `pastelsdd/specs/` or `schemas/workspace-planning/` were
...
- `pastelsdd list` still shows deferred workspace changes as active no-task
