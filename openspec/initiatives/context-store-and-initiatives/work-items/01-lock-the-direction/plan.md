...
- `pastelsdd/initiatives/context-store-and-initiatives/*.md`
- `pastelsdd/initiatives/context-store-and-initiatives/work-items/**/*.md`
...
- `pastelsdd/changes/workspace-reimplementation-roadmap/*`
- active `pastelsdd/changes/workspace-*` proposals
- `docs/cli.md`
...
- Do not edit Pastelsdd specs as part of the initial direction lock.
