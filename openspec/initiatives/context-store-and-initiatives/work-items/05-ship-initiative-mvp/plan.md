...
- Repo-local Pastelsdd changes remain the implementation artifacts; initiatives
...
Before adding `pastelsdd initiative create/list`, add a context-store
...
```bash
pastelsdd initiative create <id> --store <store-id> --title <title> --summary <summary>
pastelsdd initiative create <id> --store-path <path> --title <title> --summary <summary>
pastelsdd initiative list --store <store-id>
pastelsdd initiative list --store-path <path>
```

Use `initiative create/list` as a deliberate noun namespace, similar to
`workspace` and `schema`, even though newer Pastelsdd conventions generally
...
- Registered `pastelsdd initiative create` and `pastelsdd initiative list` from
  the top-level CLI.
- Added `pastelsdd initiative ls` as an alias for list.
