...
- Extend schema discovery and diagnostics to distinguish project-local, remote, user-level, and package schemas.
...
- Preserve all existing project-local, user-level, and package schema behavior.
