...
Define the install scope model for Pastelsdd-generated skills and commands, including scope preference, effective scope resolution, and fallback/error semantics.
...
- **AND** SHALL automatically remove only Pastelsdd-managed files in the previous effective scope
