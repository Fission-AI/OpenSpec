...
1. `pastelsdd/initiatives/context-store-and-initiatives/direction.md`
2. `pastelsdd/initiatives/context-store-and-initiatives/roadmap.md`
...
1. `pastelsdd/initiatives/context-store-and-initiatives/direction.md`
2. `pastelsdd/initiatives/context-store-and-initiatives/roadmap.md`
3. `pastelsdd/changes/workspace-reimplementation-roadmap/HISTORICAL_DIRECTION.md`
4. `pastelsdd/changes/workspace-reimplementation-roadmap/README.md`
5. `pastelsdd/changes/workspace-reimplementation-roadmap/POC_REFERENCE_GUIDE.md`
...
The original flat Pastelsdd order was:
...
repo-local Pastelsdd artifact so future sessions do not depend on chat history.
