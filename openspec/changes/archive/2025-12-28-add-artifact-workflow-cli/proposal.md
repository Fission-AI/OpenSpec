...
- **NEW**: `pastelsdd status --change <id>` shows artifact completion state
- **NEW**: `pastelsdd next --change <id>` shows artifacts ready to create
- **NEW**: `pastelsdd instructions <artifact> --change <id>` outputs enriched template
- **NEW**: `pastelsdd templates [--schema <name>]` shows resolved template paths
- **NEW**: `pastelsdd new change <name>` creates a new change directory
