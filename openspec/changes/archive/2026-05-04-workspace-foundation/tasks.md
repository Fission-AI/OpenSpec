...
- [x] 1.2 Settle `.pastelsdd-workspace/` as the workspace metadata directory
...
- [x] 1.7 Capture that planning can include repos or monorepo folders without repo-local Pastelsdd state
...
- [x] 2.1 Add workspace path constants and helpers for `.pastelsdd-workspace/`, `workspace.yaml`, `local.yaml`, and root `changes/`
...
- [x] 2.5 Ensure repo-local `pastelsdd/` projects are not mistaken for coordination workspaces
...
- [x] 3.3 Ensure local-state files are treated as machine-local and Pastelsdd-created workspaces exclude `.pastelsdd-workspace/local.yaml` from portable collaboration state
...
- [x] 4.2 Document how `.pastelsdd-workspace/` differs from repo-local `pastelsdd/`
...
- [x] 4.6 Document linked repos/folders without repo-local Pastelsdd and large-monorepo planning behavior
...
- [x] 5.6 Add tests or docs coverage that linked repos/folders do not require repo-local `pastelsdd/`
...
- [x] 5.9 Add tests or docs coverage for `.pastelsdd-workspace/local.yaml` exclusion in Pastelsdd-created workspaces
- [x] 5.10 Run `pastelsdd validate workspace-foundation --strict`
