...
- [x] 1.3 Capture that linked repos or folders and monorepo paths are allowed without repo-local Pastelsdd state
...
- [x] 2.1 Implement `pastelsdd workspace setup` as the only public creation path
...
- [x] 4.1 Implement `pastelsdd workspace list`
- [x] 4.2 Add `workspace ls` as an alias for `workspace list`
- [x] 4.3 List known Pastelsdd-managed workspaces from the local workspace registry
...
- [x] 6.1 Implement `pastelsdd workspace link <path>` with inferred link names
- [x] 6.2 Implement `pastelsdd workspace link <name> <path>` with explicit link names
- [x] 6.3 Accept full repo roots and monorepo package/service/app folder paths
- [x] 6.4 Require linked paths to exist
- [x] 6.5 Allow links without repo-local `pastelsdd/`
...
- [x] 7.1 Implement `pastelsdd workspace relink <name> <path>`
...
- [x] 8.1 Implement `pastelsdd workspace doctor` for one selected workspace only
...
- [x] 8.5 Report `repo_specs_path` when repo-local `pastelsdd/specs` exists and `null` otherwise
...
- [x] 10.1 Run `pastelsdd validate workspace-create-and-register-repos --strict`
...
- [x] 10.3 Run targeted tests for links without repo-local Pastelsdd and monorepo folder links
