# Change: Add /pastel:verify Skill
...
- Update help text to include `/pastel:verify` in the list of available commands
- Create `pastel-verify-skill` capability spec
...
- Affected specs: New `pastel-verify-skill` spec
- Affected code:
...
- Generated artifacts: When users run `pastelsdd artifact-experimental-setup`:
  - Creates `.claude/skills/pastelsdd-verify-change/SKILL.md`
  - Creates `.claude/commands/pastel/verify.md`
- Related skills: Works alongside `/pastel:apply` and before `/pastel:archive`
