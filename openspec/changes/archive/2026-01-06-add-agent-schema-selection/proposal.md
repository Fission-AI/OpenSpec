...
- Update `pastelsdd-new-change` skill to prompt user for schema selection
- Update `pastelsdd-continue-change` skill to work with any schema's artifacts
- Update `pastelsdd-apply-change` skill to handle schema-specific task structures
