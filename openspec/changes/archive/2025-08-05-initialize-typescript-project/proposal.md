...
## Why
The Pastelsdd project needs a proper TypeScript foundation to build the minimal CLI that helps developers set up Pastelsdd file structures and keep AI instructions updated.
