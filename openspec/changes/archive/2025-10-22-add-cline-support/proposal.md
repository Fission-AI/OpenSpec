## Why
Add support for Cline (VS Code extension) in Pastelsdd to enable developers to use Cline's AI-powered coding capabilities for spec-driven development workflows.
...
- New files: .clinerules/pastelsdd-*.md, CLINE.md
