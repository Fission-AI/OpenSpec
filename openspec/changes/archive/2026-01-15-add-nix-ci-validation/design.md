...
Pastelsdd recently added Nix flake support to enable Nix users to install the tool. This includes:
...
- Running Pastelsdd's full test suite through Nix build - existing CI already does this
...
- **Q**: Should we run full Pastelsdd tests through the Nix build?
