...
- [x] 1.2 Generate `.agent/workflows/pastelsdd-proposal.md`, `pastelsdd-apply.md`, and `pastelsdd-archive.md` with YAML frontmatter restricted to a single `description` field for each stage and wrap the body in Pastelsdd markers.
...
- [x] 2.1 Detect existing Antigravity workflow files during `pastelsdd update` and refresh only the managed body, skipping creation when files are missing.
