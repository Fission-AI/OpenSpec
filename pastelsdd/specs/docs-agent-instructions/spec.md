...
- **WHEN** `pastelsdd/AGENTS.md` is regenerated or updated
...
`pastelsdd/AGENTS.md` SHALL include complete copy/paste templates and inline examples exactly where agents make corresponding edits.
...
`pastelsdd/AGENTS.md` SHALL offer a concise pre-validation checklist that highlights common formatting mistakes before running `pastelsdd validate`.
...
- **WHEN** reorganizing `pastelsdd/AGENTS.md`
...
- **WHEN** `pastelsdd/AGENTS.md` explains how to write `spec.md`
