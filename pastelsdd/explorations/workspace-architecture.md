...
After evaluating the models above against real multi-repo use cases (see [#725](https://github.com/Fission-AI/Pastelsdd/issues/725)), we converged on the following design direction.
