...
- [ ] 1.4 Extend `pastelsdd config list` output to show install scope and source (`explicit`, `new-default`, `legacy-default`)
...
- [ ] 4.1 Add scope override flag to `pastelsdd init` (`--scope global|project`)
...
- [ ] 5.1 Add scope override flag to `pastelsdd update` (`--scope global|project`)
...
- [ ] 6.1 Extend `pastelsdd config profile` interactive flow to select install scope
