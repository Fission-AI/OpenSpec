...
around initiative status and linked repo-local Pastelsdd changes, not around
...
- `pastel-verify-skill`: Adds workspace verification guidance.
- `pastel-archive-skill`: Adds workspace archive guidance.
