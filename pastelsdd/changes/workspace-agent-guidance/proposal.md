...
around initiatives linked to repo-local Pastelsdd changes, not around a
...
Pastelsdd workspaces let users create a planning home and link repos or folders
...
they are in a normal repo-local Pastelsdd project. They do not have a clear
...
- the product goal can be lost between workspace exploration and change
  creation
- workspace planning can feel like a separate mode instead of normal Pastelsdd
...
This should feel to the user like the ordinary Pastelsdd proposal flow, just with
