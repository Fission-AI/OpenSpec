...
- [x] 3.3 Run `pastelsdd init --tools opencode` in a temp directory and verify:
  - Command files in `.opencode/command/` contain `/pastel-` references (not `/pastel:`)
  - Skill files in `.opencode/skills/` contain `/pastel-` references (not `/pastel:`)
