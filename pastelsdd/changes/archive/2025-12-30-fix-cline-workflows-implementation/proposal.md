...
- **BREAKING**: Existing Cline users will need to re-run `pastelsdd init` to get the corrected workflow files
...
- Modified files: `.clinerules/workflows/pastelsdd-*.md` (moved from `.clinerules/pastelsdd-*.md`)
