...
- [x] Change FILE_PATHS in `src/core/configurators/slash/cline.ts` from `.clinerules/pastelsdd-*.md` to `.clinerules/workflows/pastelsdd-*.md`
...
- [x] Verify the change follows Pastelsdd conventions
