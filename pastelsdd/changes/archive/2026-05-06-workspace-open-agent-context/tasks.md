...
- [x] 3.2 Create or refresh root `AGENTS.md` with an Pastelsdd-managed workspace guidance block
...
- [x] 4.1 Add `pastelsdd workspace open [name]`
- [x] 4.2 Support `pastelsdd workspace open --workspace <name>` as an alias for the positional name
...
- [x] 4.8 Report unresolved workspace selection clearly and suggest `pastelsdd workspace setup`
...
- [x] 6.6 Report skipped broken links with `pastelsdd workspace doctor` as the repair path
...
- [x] 8.1 Run `node bin/pastelsdd.js validate workspace-open-agent-context --strict`
