...
- [x] Verify bash completions work manually: `pastelsdd completion install bash && exec bash`
...
- [x] Verify fish completions work manually: `pastelsdd completion install fish`
...
- [x] Run `pastelsdd validate extend-shell-completions --strict` and resolve all issues
- [x] Update error messages to list all four supported shells
- [x] Verify `pastelsdd completion --help` documentation is current
