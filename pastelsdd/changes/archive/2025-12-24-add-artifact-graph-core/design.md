...
This module will coexist with the current Pastelsdd system as a parallel capability, potentially enabling future migration or integration.
...
- Replacing existing Pastelsdd functionality
...
**Resolution order:**
1. `${XDG_DATA_HOME:-~/.local/share}/pastelsdd/schemas/<name>.yaml` - Global user override
...
- Global user override: `${XDG_DATA_HOME:-~/.local/share}/pastelsdd/schemas/<name>.yaml`
