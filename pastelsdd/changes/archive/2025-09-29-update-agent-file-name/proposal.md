...
## Problem
The agent instructions live in `pastelsdd/README.md`, which clashes with conventional project README usage and creates confusion for tooling and contributors.

## Solution
Rename the agent instruction file to `pastelsdd/AGENTS.md` and update Pastelsdd tooling to use the new filename:
- `pastelsdd init` generates `AGENTS.md` instead of `README.md`
...
## Success Metrics
- `pastelsdd init` creates `pastelsdd/AGENTS.md`
- `pastelsdd update` refreshes `AGENTS.md`
- All specs reference `pastelsdd/AGENTS.md`
