...
- [x] 1.2 Ensure `pastelsdd templates --schema <name>` returns artifact list for any schema
...
- [x] 2.3 Pass selected schema to `pastelsdd new change --schema <name>`
...
- [x] 3.2 Read artifact list dynamically from `pastelsdd status --json`
