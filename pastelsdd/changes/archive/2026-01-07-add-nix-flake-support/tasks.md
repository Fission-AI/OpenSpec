...
- [x] 4.2 Verify binary ends up in $out/bin/pastelsdd
...
- [x] 5.4 Set meta.mainProgram = "pastelsdd"

## 6. Configure App Entry Point

- [x] 6.1 Add apps output with forAllSystems
- [x] 6.2 Set default app to pastelsdd binary
...
- [ ] 9.5 Test `nix run github:thiagodiogo/Pastelsdd -- init` after merge to main
