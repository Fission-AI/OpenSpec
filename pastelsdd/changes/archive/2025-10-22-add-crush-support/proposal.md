## Why
Add support for Crush AI assistant in Pastelsdd to enable developers to use Crush's enhanced capabilities for spec-driven development workflows.
...
- New files: .crush/commands/pastelsdd/ (proposal.md, apply.md, archive.md)