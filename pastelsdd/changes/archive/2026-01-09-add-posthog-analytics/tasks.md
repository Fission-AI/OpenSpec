...
- [x] 2.1 Create or extend global config module for `~/.config/pastelsdd/config.json`
...
- [x] 3.1 Implement `isTelemetryEnabled()` checking `PASTELSDD_TELEMETRY`, `DO_NOT_TRACK`, and `CI` env vars
...
- [x] 4.3 Display notice text: "Note: Pastelsdd collects anonymous usage stats. Opt out: PASTELSDD_TELEMETRY=0"
...
- [x] 6.1 Test opt-out via `PASTELSDD_TELEMETRY=0`
...
- [x] 7.2 Document opt-out methods (`PASTELSDD_TELEMETRY=0`, `DO_NOT_TRACK=1`)
