...
- **WHEN** a user runs `pastelsdd change graph`
...
- **WHEN** a user runs `pastelsdd change next`
...
- **WHEN** a user runs `pastelsdd change split <change-id>`
...
- **WHEN** a user runs `pastelsdd change split <change-id>` for a parent whose generated child directories already exist
