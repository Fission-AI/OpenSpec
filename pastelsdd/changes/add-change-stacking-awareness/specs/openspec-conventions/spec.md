...
Pastelsdd conventions SHALL define optional metadata fields for sequencing and decomposition across concurrent changes.
...
- **WHEN** both stack metadata and `pastelsdd/changes/IMPLEMENTATION_ORDER.md` are present
