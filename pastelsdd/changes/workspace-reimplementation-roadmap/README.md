...
`pastelsdd/initiatives/context-store-and-initiatives/`. Fresh agents should use
...
Fresh agents should read `POC_REFERENCE_GUIDE.md` before implementing any slice. That guide explains how to inspect the pinned POC commit, which files to read for each slice, and what findings to bring back into the Pastelsdd artifacts.
...
Pastelsdd currently discovers active changes as immediate directories under `pastelsdd/changes/`, and change names are kebab-case identifiers. These changes remain useful reference artifacts, but they are no longer a direct implementation queue.
...
pastelsdd/initiatives/context-store-and-initiatives/direction.md and
pastelsdd/initiatives/context-store-and-initiatives/roadmap.md first. Use
...
pastelsdd/changes/workspace-reimplementation-roadmap/POC_REFERENCE_GUIDE.md, and
