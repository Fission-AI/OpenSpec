...
After review, the standalone `pastelsdd initiative resolve <id>` command should
...
pastelsdd context-store register ./context --id platform
...
- Item 8 stores initiative links in repo-local `.pastelsdd.yaml` as
  `{ store, id }`.
