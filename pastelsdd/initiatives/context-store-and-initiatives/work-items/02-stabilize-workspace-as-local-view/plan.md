...
- Use repo-local Pastelsdd changes for implementation plans owned by a repo or
  team.
...
- Use Pastelsdd workspace commands instead of hand-editing
  `.pastelsdd-workspace/*.yaml`.
