...
- [x] Record why roadmap implementation is tracked inside the initiative instead
  of creating a new Pastelsdd change.

## Direction Lock Already Captured

- [x] Add locked disposition to `roadmap.md`.
- [x] Add locked product boundary to `direction.md`.
- [x] Mark `pastelsdd/changes/workspace-reimplementation-roadmap/START_HERE.md` as historical reference.
- [x] Mark `pastelsdd/changes/workspace-reimplementation-roadmap/HISTORICAL_DIRECTION.md` as historical reference.
...
- [x] Keep Pastelsdd specs unchanged until behavior changes.
...
- [x] Confirm no Pastelsdd specs were modified in this pass.
