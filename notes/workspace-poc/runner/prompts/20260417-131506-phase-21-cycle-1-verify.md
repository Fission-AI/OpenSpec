...
- Read the phase block plus existing notes/workspace-poc/phase-21-workspace-guidance-and-owners//SUMMARY.md.
...
- Write or update notes/workspace-poc/phase-21-workspace-guidance-and-owners//VERIFY.md with:
  1. checks performed
  2. issues found
  3. fixes applied
