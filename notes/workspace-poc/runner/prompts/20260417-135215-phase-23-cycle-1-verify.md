...
- Read the phase block plus existing notes/workspace-poc/phase-23-workspace-target-set-adjustment//SUMMARY.md.
...
- Write or update notes/workspace-poc/phase-23-workspace-target-set-adjustment//VERIFY.md with:
  1. checks performed
  2. issues found
  3. fixes applied
