...
- Read the phase block plus existing notes/workspace-poc/phase-17-test-workspace-archive//SUMMARY.md.
...
- Write or update notes/workspace-poc/phase-17-test-workspace-archive//VERIFY.md with:
  1. checks performed
  2. issues found
  3. fixes applied
