...
- Read the phase block plus existing notes/workspace-poc/phase-20-prd-audit//SUMMARY.md.
...
- Write or update notes/workspace-poc/phase-20-prd-audit//VERIFY.md with:
  1. checks performed
  2. issues found
  3. fixes applied
