...
- Read the phase block plus existing notes/workspace-poc/phase-01-workspace-create//SUMMARY.md.
...
- Write or update notes/workspace-poc/phase-01-workspace-create//VERIFY.md with:
  1. checks performed
  2. issues found
  3. fixes applied
