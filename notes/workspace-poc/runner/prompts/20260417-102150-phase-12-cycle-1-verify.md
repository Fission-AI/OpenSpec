...
- Read the phase block plus existing notes/workspace-poc/phase-12-test-apply-materialization//SUMMARY.md.
...
- Write or update notes/workspace-poc/phase-12-test-apply-materialization//VERIFY.md with:
  1. checks performed
  2. issues found
  3. fixes applied
