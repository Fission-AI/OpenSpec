...
describe('initiative command', () => {
  ...
  beforeEach(() => {
    tempDir = fs.mkdtempSync(path.join(os.tmpdir(), 'pastelsdd-initiative-command-'));
  ...
  it('prints readable human output for create and list', async () => {
    ...
    expect(create.stdout).toContain('pastelsdd initiative list --store team-context');
    ...
    expect(list.exitCode).toBe(0);
    expect(list.stdout).toContain('Pastelsdd initiatives in team-context (1)');
  ...
  it('prints compact all-store human output without initiative statuses', async () => {
    ...
    expect(list.exitCode).toBe(0);
    expect(list.stdout).toContain('Pastelsdd initiatives (1 across 2 stores)');
  ...
  it('prints compact human output for initiative show', async () => {
    ...
    expect(show.exitCode).toBe(0);
    expect(show.stdout).toContain('Pastelsdd initiative: Billing Launch');
