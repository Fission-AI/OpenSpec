...
describe('interactive utilities', () => {
  let originalLightSpecInteractive: string | undefined;
  let originalCI: string | undefined;
  let originalStdinIsTTY: boolean | undefined;

  beforeEach(() => {
    // Save original environment
    originalLightSpecInteractive = process.env.OPEN_SPEC_INTERACTIVE;
  ...
  afterEach(() => {
    ...
    if (originalLightSpecInteractive !== undefined) {
      process.env.OPEN_SPEC_INTERACTIVE = originalLightSpecInteractive;
    } else {
      delete process.env.OPEN_SPEC_INTERACTIVE;
    }
