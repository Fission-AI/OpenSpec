...
describe('FishGenerator', () => {
  ...
  describe('generate', () => {
    ...
    it('should generate helper functions for Fish', () => {
      ...
      expect(script).toContain('function __fish_lightspec_using_subcommand');
      expect(script).toContain('function __fish_lightspec_no_subcommand');
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain("__fish_lightspec_using_subcommand change");
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain('__fish_lightspec_changes');
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain('__fish_lightspec_specs');
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain('__fish_lightspec_items');
    });
    ...
    it('should generate dynamic completion helper for changes', () => {
      ...
      expect(script).toContain('function __fish_lightspec_changes');
      expect(script).toContain('lightspec __complete changes 2>/dev/null');
    ...
    it('should generate dynamic completion helper for specs', () => {
      ...
      expect(script).toContain('function __fish_lightspec_specs');
      expect(script).toContain('lightspec __complete specs 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for items', () => {
      ...
      expect(script).toContain('function __fish_lightspec_items');
      expect(script).toContain('__fish_lightspec_changes');
      expect(script).toContain('__fish_lightspec_specs');
    });
