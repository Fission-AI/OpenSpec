...
describe('FishGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid fish completion script with header', () => {
      ...
      expect(script).toContain('# Fish completion script for ClearSpec CLI');
      expect(script).toContain('function __fish_clearspec');
    });
    ...
    it('should generate helper functions for Fish', () => {
      ...
      expect(script).toContain('function __fish_clearspec_using_subcommand');
      expect(script).toContain('function __fish_clearspec_no_subcommand');
    ...
    it('should include all commands with descriptions', () => {
      ...
      expect(script).toContain("complete -c clearspec");
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain("__fish_clearspec_using_subcommand change");
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain('__fish_clearspec_changes');
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain('__fish_clearspec_specs');
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain('__fish_clearspec_items');
    });
    ...
    it('should handle positional arguments for schema names', () => {
      ...
      expect(script).toContain('__fish_clearspec_schemas');
      expect(script).toContain('clearspec __complete schemas 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for changes', () => {
      ...
      expect(script).toContain('function __fish_clearspec_changes');
      expect(script).toContain('clearspec __complete changes 2>/dev/null');
    ...
    it('should generate dynamic completion helper for specs', () => {
      ...
      expect(script).toContain('function __fish_clearspec_specs');
      expect(script).toContain('clearspec __complete specs 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for items', () => {
      ...
      expect(script).toContain('function __fish_clearspec_items');
      expect(script).toContain('__fish_clearspec_changes');
      expect(script).toContain('__fish_clearspec_specs');
    });
