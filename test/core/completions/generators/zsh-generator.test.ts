...
describe('ZshGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid zsh completion script with header', () => {
      ...
      expect(script).toContain('#compdef clearspec');
      expect(script).toContain('# Zsh completion script for ClearSpec CLI');
      expect(script).toContain('_clearspec() {');
    });
    ...
    it('should include all commands in the command list', () => {
      ...
      expect(script).toContain("'init:Initialize ClearSpec'");
    ...
    it('should generate command completion functions', () => {
      ...
      expect(script).toContain('_clearspec_init() {');
      expect(script).toContain('_clearspec_validate() {');
    });
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain('_clearspec_change_show() {');
      expect(script).toContain('_clearspec_change_list() {');
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain("'*: :_clearspec_complete_changes'");
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain("'*: :_clearspec_complete_specs'");
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain("'*: :_clearspec_complete_items'");
    });
    ...
    it('should handle positional arguments for schema names', () => {
      ...
      expect(script).toContain("'*: :_clearspec_complete_schemas'");
      expect(script).toContain('_clearspec_complete_schemas()');
    });
    ...
    it('should sanitize command names with hyphens for function names', () => {
      ...
      expect(script).toContain('_clearspec_my_command() {');
    });
    ...
    it('should handle complex nested subcommands with flags', () => {
      ...
      expect(script).toContain('_clearspec_spec() {');
      expect(script).toContain('_clearspec_spec_validate() {');
      expect(script).toContain('--strict');
      expect(script).toContain('--json');
      expect(script).toContain("'*: :_clearspec_complete_specs'");
    });
    ...
    it('should generate script that ends with compdef registration', () => {
      ...
      expect(script.trim().endsWith('compdef _clearspec clearspec')).toBe(true);
    });
    ...
    it('should handle commands with no flags', () => {
      ...
      expect(script).toContain('_clearspec_view() {');
