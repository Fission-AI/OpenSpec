...
describe('command-generation/adapters', () => {
  ...
  describe('claudeAdapter', () => {
    ...
    it('should format file with correct YAML frontmatter', () => {
      ...
      expect(output).toContain('name: Pastelsdd Explore');
  ...
  describe('windsurfAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.windsurf', 'workflows', 'pastel-explore.md'));
    });
  ...
  describe('amazonQAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.amazonq', 'prompts', 'pastel-explore.md'));
    });
  ...
  describe('antigravityAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.agent', 'workflows', 'pastel-explore.md'));
    });
  ...
  describe('auggieAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.augment', 'commands', 'pastel-explore.md'));
    });
  ...
  describe('bobAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.bob', 'commands', 'pastel-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(bobAdapter.getFilePath('new')).toBe(path.join('.bob', 'commands', 'pastel-new.md'));
      expect(bobAdapter.getFilePath('bulk-archive')).toBe(path.join('.bob', 'commands', 'pastel-bulk-archive.md'));
    });
    ...
    it('should transform colon command references to hyphen format', () => {
      const contentWithRefs: CommandContent = {
        ...sampleContent,
        body: 'Run /pastel:apply to implement. Then use /pastel:verify.',
      };
      const output = bobAdapter.formatFile(contentWithRefs);
      expect(output).toContain('/pastel-apply');
      expect(output).toContain('/pastel-verify');
      expect(output).not.toContain('/pastel:apply');
      expect(output).not.toContain('/pastel:verify');
    });
  ...
  describe('codebuddyAdapter', () => {
    ...
    it('should generate correct file path with nested pastel folder', () => {
      const filePath = codebuddyAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.codebuddy', 'commands', 'pastel', 'explore.md'));
    });
  ...
  describe('continueAdapter', () => {
    ...
    it('should generate correct file path with .prompt extension', () => {
      ...
      expect(filePath).toBe(path.join('.continue', 'prompts', 'pastel-explore.prompt'));
    });
  ...
  describe('costrictAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.cospec', 'pastelsdd', 'commands', 'pastel-explore.md'));
    });
  ...
  describe('crushAdapter', () => {
    ...
    it('should generate correct file path with nested pastel folder', () => {
      ...
      expect(filePath).toBe(path.join('.crush', 'commands', 'pastel', 'explore.md'));
    });
  ...
  describe('factoryAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.factory', 'commands', 'pastel-explore.md'));
    });
  ...
  describe('iflowAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.iflow', 'commands', 'pastel-explore.md'));
    });
  ...
  describe('kilocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.kilocode', 'workflows', 'pastel-explore.md'));
    });
  ...
  describe('opencodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.opencode', 'commands', 'pastel-explore.md'));
    });
    ...
    it('should transform colon-based command references to hyphen-based', () => {
      const contentWithCommands: CommandContent = {
        ...sampleContent,
        body: 'Use /pastel:new to start, then /pastel:apply to implement.',
      };
      const output = opencodeAdapter.formatFile(contentWithCommands);
      expect(output).toContain('/pastel-new');
      expect(output).toContain('/pastel-apply');
      expect(output).not.toContain('/pastel:new');
      expect(output).not.toContain('/pastel:apply');
    });
    ...
    it('should handle multiple command references in body', () => {
      const contentWithMultipleCommands: CommandContent = {
        ...sampleContent,
        body: `/pastel:explore for ideas
/pastel:new to create
/pastel:continue to proceed
/pastel:apply to implement`,
      };
      const output = opencodeAdapter.formatFile(contentWithMultipleCommands);
      expect(output).toContain('/pastel-explore');
      expect(output).toContain('/pastel-new');
      expect(output).toContain('/pastel-continue');
      expect(output).toContain('/pastel-apply');
    });
  });
  ...
  describe('qoderAdapter', () => {
    ...
    it('should generate correct file path with nested pastel folder', () => {
      ...
      expect(filePath).toBe(path.join('.qoder', 'commands', 'pastel', 'explore.md'));
    });
  ...
  describe('qwenAdapter', () => {
    ...
    it('should generate correct file path with .toml extension', () => {
      ...
      expect(filePath).toBe(path.join('.qwen', 'commands', 'pastel-explore.toml'));
    });
  ...
  describe('piAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.pi', 'prompts', 'pastel-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(piAdapter.getFilePath('new')).toBe(path.join('.pi', 'prompts', 'pastel-new.md'));
      expect(piAdapter.getFilePath('bulk-archive')).toBe(path.join('.pi', 'prompts', 'pastel-bulk-archive.md'));
    });
    ...
    it('should transform command references from colon to hyphen format', () => {
      const contentWithRefs: CommandContent = {
        ...sampleContent,
        body: 'Run /pastel:apply to implement. Then /pastel:archive when done.',
      };

      const output = piAdapter.formatFile(contentWithRefs);
      expect(output).toContain('/pastel-apply');
      expect(output).toContain('/pastel-archive');
      expect(output).not.toContain('/pastel:apply');
    });
    ...
    it('should inject template arguments into the input section', () => {
      const contentWithInput: CommandContent = {
        ...sampleContent,
        body: '**Input**: The argument after `/pastel:explore` is the topic.\n\n**Steps**\n1. Think.',
      };
  ...
  describe('roocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.roo', 'commands', 'pastel-explore.md'));
    });
  ...
  describe('cross-platform path handling', () => {
    ...
    it('Windsurf adapter uses path.join for paths', () => {
      ...
      expect(filePath.split(path.sep)).toEqual(['.windsurf', 'workflows', 'pastel-test.md']);
    });
