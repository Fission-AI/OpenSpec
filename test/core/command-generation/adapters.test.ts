...
describe('command-generation/adapters', () => {
  ...
  describe('claudeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.claude', 'commands', 'enpalspec', 'explore.md'));
    });

    it('should generate correct file path for different command IDs', () => {
      expect(claudeAdapter.getFilePath('new')).toBe(path.join('.claude', 'commands', 'enpalspec', 'new.md'));
      expect(claudeAdapter.getFilePath('bulk-archive')).toBe(path.join('.claude', 'commands', 'enpalspec', 'bulk-archive.md'));
    });
  ...
  describe('cursorAdapter', () => {
    ...
    it('should generate correct file path with enpalspec- prefix', () => {
      const filePath = cursorAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.cursor', 'commands', 'enpalspec-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(cursorAdapter.getFilePath('new')).toBe(path.join('.cursor', 'commands', 'enpalspec-new.md'));
      expect(cursorAdapter.getFilePath('bulk-archive')).toBe(path.join('.cursor', 'commands', 'enpalspec-bulk-archive.md'));
    });
    ...
    it('should format file with Cursor-specific frontmatter', () => {
      ...
      expect(output).toContain('---\n');
      expect(output).toContain('name: /enpalspec-explore');
      expect(output).toContain('id: enpalspec-explore');
      expect(output).toContain('category: Workflow');
      expect(output).toContain('description: Enter explore mode for thinking');
      expect(output).toContain('---\n\n');
      expect(output).toContain('This is the command body.');
  ...
  describe('windsurfAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.windsurf', 'workflows', 'enpalspec-explore.md'));
    });
  ...
  describe('amazonQAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.amazonq', 'prompts', 'enpalspec-explore.md'));
    });
  ...
  describe('antigravityAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.agent', 'workflows', 'enpalspec-explore.md'));
    });
  ...
  describe('auggieAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.augment', 'commands', 'enpalspec-explore.md'));
    });
  ...
  describe('clineAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.clinerules', 'workflows', 'enpalspec-explore.md'));
    });
  ...
  describe('codexAdapter', () => {
    ...
    it('should generate path ending with correct structure', () => {
      const filePath = codexAdapter.getFilePath('explore');
      expect(filePath).toMatch(/prompts[/\\]enpalspec-explore\.md$/);
    });
    ...
    it('should default to homedir/.codex', () => {
      ...
      try {
        const filePath = codexAdapter.getFilePath('explore');
        const expected = path.join(os.homedir(), '.codex', 'prompts', 'enpalspec-explore.md');
    ...
    it('should respect CODEX_HOME env var', () => {
      ...
      try {
        const filePath = codexAdapter.getFilePath('explore');
        expect(filePath).toBe(path.join(path.resolve('/custom/codex-home'), 'prompts', 'enpalspec-explore.md'));
      } finally {
        if (original !== undefined) {
          process.env.CODEX_HOME = original;
        } else {
  ...
  describe('codebuddyAdapter', () => {
    ...
    it('should generate correct file path with nested enpalspec folder', () => {
      const filePath = codebuddyAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.codebuddy', 'commands', 'enpalspec', 'explore.md'));
    });
  ...
  describe('continueAdapter', () => {
    ...
    it('should generate correct file path with .prompt extension', () => {
      ...
      expect(filePath).toBe(path.join('.continue', 'prompts', 'enpalspec-explore.prompt'));
    });
  ...
  describe('costrictAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.cospec', 'openspec', 'commands', 'enpalspec-explore.md'));
    });
  ...
  describe('crushAdapter', () => {
    ...
    it('should generate correct file path with nested enpalspec folder', () => {
      ...
      expect(filePath).toBe(path.join('.crush', 'commands', 'enpalspec', 'explore.md'));
    });
  ...
  describe('factoryAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.factory', 'commands', 'enpalspec-explore.md'));
    });
  ...
  describe('geminiAdapter', () => {
    ...
    it('should generate correct file path with .toml extension', () => {
      ...
      expect(filePath).toBe(path.join('.gemini', 'commands', 'enpalspec', 'explore.toml'));
    });
  ...
  describe('githubCopilotAdapter', () => {
    ...
    it('should generate correct file path with .prompt.md extension', () => {
      ...
      expect(filePath).toBe(path.join('.github', 'prompts', 'enpalspec-explore.prompt.md'));
    });
  ...
  describe('iflowAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.iflow', 'commands', 'enpalspec-explore.md'));
    });
  ...
  describe('kilocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.kilocode', 'workflows', 'enpalspec-explore.md'));
    });
  ...
  describe('opencodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.opencode', 'commands', 'enpalspec-explore.md'));
    });
...
/opsx:apply to implement`,
  ...
  describe('qoderAdapter', () => {
    ...
    it('should generate correct file path with nested enpalspec folder', () => {
      ...
      expect(filePath).toBe(path.join('.qoder', 'commands', 'enpalspec', 'explore.md'));
    });
  ...
  describe('qwenAdapter', () => {
    ...
    it('should generate correct file path with .toml extension', () => {
      ...
      expect(filePath).toBe(path.join('.qwen', 'commands', 'enpalspec-explore.toml'));
    });
  ...
  describe('piAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.pi', 'prompts', 'enpalspec-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(piAdapter.getFilePath('new')).toBe(path.join('.pi', 'prompts', 'enpalspec-new.md'));
      expect(piAdapter.getFilePath('bulk-archive')).toBe(path.join('.pi', 'prompts', 'enpalspec-bulk-archive.md'));
    });
  ...
  describe('roocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.roo', 'commands', 'enpalspec-explore.md'));
    });
  ...
  describe('cross-platform path handling', () => {
    it('Claude adapter uses path.join for paths', () => {
      ...
      expect(filePath.split(path.sep)).toEqual(['.claude', 'commands', 'enpalspec', 'test.md']);
    });

    it('Cursor adapter uses path.join for paths', () => {
      const filePath = cursorAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.cursor', 'commands', 'enpalspec-test.md']);
    });

    it('Windsurf adapter uses path.join for paths', () => {
      const filePath = windsurfAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.windsurf', 'workflows', 'enpalspec-test.md']);
    });
