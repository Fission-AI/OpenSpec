...
describe('command-generation/adapters', () => {
  ...
  describe('claudeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.claude', 'commands', 'clsx', 'explore.md'));
    });

    it('should generate correct file path for different command IDs', () => {
      expect(claudeAdapter.getFilePath('new')).toBe(path.join('.claude', 'commands', 'clsx', 'new.md'));
      expect(claudeAdapter.getFilePath('bulk-archive')).toBe(path.join('.claude', 'commands', 'clsx', 'bulk-archive.md'));
    });
    ...
    it('should format file with correct YAML frontmatter', () => {
      ...
      expect(output).toContain('name: ClearSpec Explore');
  ...
  describe('cursorAdapter', () => {
    ...
    it('should generate correct file path with clsx- prefix', () => {
      const filePath = cursorAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.cursor', 'commands', 'clsx-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(cursorAdapter.getFilePath('new')).toBe(path.join('.cursor', 'commands', 'clsx-new.md'));
      expect(cursorAdapter.getFilePath('bulk-archive')).toBe(path.join('.cursor', 'commands', 'clsx-bulk-archive.md'));
    });
    ...
    it('should format file with Cursor-specific frontmatter', () => {
      ...
      expect(output).toContain('---\n');
      expect(output).toContain('name: /clsx-explore');
      expect(output).toContain('id: clsx-explore');
      expect(output).toContain('category: Workflow');
      expect(output).toContain('description: Enter explore mode for thinking');
      expect(output).toContain('---\n\n');
      expect(output).toContain('This is the command body.');
  ...
  describe('windsurfAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.windsurf', 'workflows', 'clsx-explore.md'));
    });
  ...
  describe('amazonQAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.amazonq', 'prompts', 'clsx-explore.md'));
    });
  ...
  describe('antigravityAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.agent', 'workflows', 'clsx-explore.md'));
    });
  ...
  describe('auggieAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.augment', 'commands', 'clsx-explore.md'));
    });
  ...
  describe('bobAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.bob', 'commands', 'clsx-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(bobAdapter.getFilePath('new')).toBe(path.join('.bob', 'commands', 'clsx-new.md'));
      expect(bobAdapter.getFilePath('bulk-archive')).toBe(path.join('.bob', 'commands', 'clsx-bulk-archive.md'));
    });
    ...
    it('should transform colon command references to hyphen format', () => {
      const contentWithRefs: CommandContent = {
        ...sampleContent,
        body: 'Run /clsx:apply to implement. Then use /clsx:verify.',
      };
      const output = bobAdapter.formatFile(contentWithRefs);
      expect(output).toContain('/clsx-apply');
      expect(output).toContain('/clsx-verify');
      expect(output).not.toContain('/clsx:apply');
      expect(output).not.toContain('/clsx:verify');
    });
  ...
  describe('codexAdapter', () => {
    ...
    it('should generate path ending with correct structure', () => {
      const filePath = codexAdapter.getFilePath('explore');
      expect(filePath).toMatch(/prompts[/\\]clsx-explore\.md$/);
    });
    ...
    it('should default to homedir/.codex', () => {
      ...
      try {
        const filePath = codexAdapter.getFilePath('explore');
        const expected = path.join(os.homedir(), '.codex', 'prompts', 'clsx-explore.md');
    ...
    it('should respect CODEX_HOME env var', () => {
      ...
      try {
        const filePath = codexAdapter.getFilePath('explore');
        expect(filePath).toBe(path.join(path.resolve('/custom/codex-home'), 'prompts', 'clsx-explore.md'));
      } finally {
        if (original !== undefined) {
          process.env.CODEX_HOME = original;
        } else {
  ...
  describe('codebuddyAdapter', () => {
    ...
    it('should generate correct file path with nested clsx folder', () => {
      const filePath = codebuddyAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.codebuddy', 'commands', 'clsx', 'explore.md'));
    });
  ...
  describe('continueAdapter', () => {
    ...
    it('should generate correct file path with .prompt extension', () => {
      ...
      expect(filePath).toBe(path.join('.continue', 'prompts', 'clsx-explore.prompt'));
    });
  ...
  describe('costrictAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.cospec', 'clearspec', 'commands', 'clsx-explore.md'));
    });
  ...
  describe('crushAdapter', () => {
    ...
    it('should generate correct file path with nested clsx folder', () => {
      ...
      expect(filePath).toBe(path.join('.crush', 'commands', 'clsx', 'explore.md'));
    });
  ...
  describe('factoryAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.factory', 'commands', 'clsx-explore.md'));
    });
  ...
  describe('geminiAdapter', () => {
    ...
    it('should generate correct file path with .toml extension', () => {
      ...
      expect(filePath).toBe(path.join('.gemini', 'commands', 'clsx', 'explore.toml'));
    });
  ...
  describe('githubCopilotAdapter', () => {
    ...
    it('should generate correct file path with .prompt.md extension', () => {
      ...
      expect(filePath).toBe(path.join('.github', 'prompts', 'clsx-explore.prompt.md'));
    });
  ...
  describe('iflowAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.iflow', 'commands', 'clsx-explore.md'));
    });
  ...
  describe('kilocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.kilocode', 'workflows', 'clsx-explore.md'));
    });
  ...
  describe('opencodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.opencode', 'commands', 'clsx-explore.md'));
    });
    ...
    it('should transform colon-based command references to hyphen-based', () => {
      const contentWithCommands: CommandContent = {
        ...sampleContent,
        body: 'Use /clsx:new to start, then /clsx:apply to implement.',
      };
      const output = opencodeAdapter.formatFile(contentWithCommands);
      expect(output).toContain('/clsx-new');
      expect(output).toContain('/clsx-apply');
      expect(output).not.toContain('/clsx:new');
      expect(output).not.toContain('/clsx:apply');
    });
    ...
    it('should handle multiple command references in body', () => {
      const contentWithMultipleCommands: CommandContent = {
        ...sampleContent,
        body: `/clsx:explore for ideas
/clsx:new to create
/clsx:continue to proceed
/clsx:apply to implement`,
      };
      const output = opencodeAdapter.formatFile(contentWithMultipleCommands);
      expect(output).toContain('/clsx-explore');
      expect(output).toContain('/clsx-new');
      expect(output).toContain('/clsx-continue');
      expect(output).toContain('/clsx-apply');
    });
  });
  ...
  describe('qoderAdapter', () => {
    ...
    it('should generate correct file path with nested clsx folder', () => {
      ...
      expect(filePath).toBe(path.join('.qoder', 'commands', 'clsx', 'explore.md'));
    });
  ...
  describe('qwenAdapter', () => {
    ...
    it('should generate correct file path with .toml extension', () => {
      ...
      expect(filePath).toBe(path.join('.qwen', 'commands', 'clsx-explore.toml'));
    });
  ...
  describe('piAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.pi', 'prompts', 'clsx-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(piAdapter.getFilePath('new')).toBe(path.join('.pi', 'prompts', 'clsx-new.md'));
      expect(piAdapter.getFilePath('bulk-archive')).toBe(path.join('.pi', 'prompts', 'clsx-bulk-archive.md'));
    });
    ...
    it('should transform command references from colon to hyphen format', () => {
      const contentWithRefs: CommandContent = {
        ...sampleContent,
        body: 'Run /clsx:apply to implement. Then /clsx:archive when done.',
      };

      const output = piAdapter.formatFile(contentWithRefs);
      expect(output).toContain('/clsx-apply');
      expect(output).toContain('/clsx-archive');
      expect(output).not.toContain('/clsx:apply');
    });
    ...
    it('should inject template arguments into the input section', () => {
      const contentWithInput: CommandContent = {
        ...sampleContent,
        body: '**Input**: The argument after `/clsx:explore` is the topic.\n\n**Steps**\n1. Think.',
      };
  ...
  describe('roocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.roo', 'commands', 'clsx-explore.md'));
    });
  ...
  describe('cross-platform path handling', () => {
    it('Claude adapter uses path.join for paths', () => {
      ...
      expect(filePath.split(path.sep)).toEqual(['.claude', 'commands', 'clsx', 'test.md']);
    });

    it('Cursor adapter uses path.join for paths', () => {
      const filePath = cursorAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.cursor', 'commands', 'clsx-test.md']);
    });

    it('Windsurf adapter uses path.join for paths', () => {
      const filePath = windsurfAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.windsurf', 'workflows', 'clsx-test.md']);
    });
