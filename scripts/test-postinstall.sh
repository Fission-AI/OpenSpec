...
echo "======================================"
echo "Testing LightSpec Postinstall Script"
echo "======================================"
echo ""

# Save original environment
ORIGINAL_CI="${CI:-}"
ORIGINAL_LIGHTSPEC_NO_COMPLETIONS="${LIGHTSPEC_NO_COMPLETIONS:-}"

# Test 1: Normal install
echo "Test 1: Normal install (should attempt to install completions)"
echo "--------------------------------------"
unset CI
unset LIGHTSPEC_NO_COMPLETIONS
...
echo "Test 3: LIGHTSPEC_NO_COMPLETIONS=1 (should skip silently)"
echo "--------------------------------------"
unset CI
export LIGHTSPEC_NO_COMPLETIONS=1
node scripts/postinstall.js
...
if [ -n "$ORIGINAL_LIGHTSPEC_NO_COMPLETIONS" ]; then
  export LIGHTSPEC_NO_COMPLETIONS="$ORIGINAL_LIGHTSPEC_NO_COMPLETIONS"
else
  unset LIGHTSPEC_NO_COMPLETIONS
fi
