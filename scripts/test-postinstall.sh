...
echo "======================================"
echo "Testing ClearSpec Postinstall Script"
echo "======================================"
echo ""

# Save original environment
ORIGINAL_CI="${CI:-}"
ORIGINAL_CLEARSPEC_NO_COMPLETIONS="${CLEARSPEC_NO_COMPLETIONS:-}"

# Test 1: Normal install
echo "Test 1: Normal install (should print tip about completions)"
echo "--------------------------------------"
unset CI
unset CLEARSPEC_NO_COMPLETIONS
...
echo "Test 3: CLEARSPEC_NO_COMPLETIONS=1 (should skip silently)"
echo "--------------------------------------"
unset CI
export CLEARSPEC_NO_COMPLETIONS=1
node scripts/postinstall.js
...
if [ -n "$ORIGINAL_CLEARSPEC_NO_COMPLETIONS" ]; then
  export CLEARSPEC_NO_COMPLETIONS="$ORIGINAL_CLEARSPEC_NO_COMPLETIONS"
else
  unset CLEARSPEC_NO_COMPLETIONS
fi
