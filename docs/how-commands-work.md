...
| none — skills only | `/openspec-propose` | CodeArts, DeepSeek Harness, ForgeCode, Hermes, MiniMax Code, Mistral Vibe, Zed Agent, shared `.agents` |
