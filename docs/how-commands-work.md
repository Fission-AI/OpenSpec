...
| none — skills only | `/openspec-propose` | CodeArts, ForgeCode, Hermes, MiniMax Code, Mistral Vibe, Warp, Zed Agent, shared `.agents` |
| none — Rovo Dev CLI | ask Rovo to use `openspec-propose` | Rovo Dev CLI |
