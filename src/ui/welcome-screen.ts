...
function getWelcomeText(): string[] {
  return [
    ...
    '',
    chalk.white('Default workflow after setup:'),
    `  ${chalk.yellow('/opsx:propose')}  ${chalk.dim('Start a change on colon-style tools')}`,
    `  ${chalk.yellow('/opsx-propose')} ${chalk.dim('Start a change on hyphen-style tools')}`,
    `  ${chalk.yellow('core')}          ${chalk.dim('Installs propose, explore, apply, archive')}`,
    '',
