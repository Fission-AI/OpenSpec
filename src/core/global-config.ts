...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'clearspec';
export const GLOBAL_CONFIG_FILE_NAME = 'config.json';
export const GLOBAL_DATA_DIR_NAME = 'clearspec';
 ...
 *
 * - All platforms: $XDG_DATA_HOME/clearspec/ if XDG_DATA_HOME is set
 * - Unix/macOS fallback: ~/.local/share/clearspec/
 * - Windows fallback: %LOCALAPPDATA%/clearspec/
 */
