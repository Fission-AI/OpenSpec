...
export const COMMAND_REGISTRY: CommandDefinition[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      {
        name: 'concurrency',
        description: 'Max concurrent validations (defaults to env LIGHTSPEC_CONCURRENCY or 6)',
        takesValue: true,
      },
  ...
  {
    name: 'change',
    description: 'Manage LightSpec change proposals (deprecated)',
    flags: [],
    subcommands: [
      {
        name: 'show',
  ...
  {
    name: 'spec',
    description: 'Manage LightSpec specifications',
    flags: [],
    subcommands: [
      {
        name: 'show',
