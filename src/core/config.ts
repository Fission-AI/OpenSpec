...
export interface AIToolOption {
  ...
  installDir?: string; // Override the skill installation directory (supports ~ for global paths, e.g. '~/.hermes/skills')
}
...
export const AI_TOOLS: AIToolOption[] = [
  ...
  { name: 'Hermes Agent', value: 'hermes', available: true, successLabel: 'Hermes Agent', skillsDir: '.hermes', installDir: '~/.hermes/skills' },
