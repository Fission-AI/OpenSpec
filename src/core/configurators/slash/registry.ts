...
import { PerplexitySlashCommandConfigurator } from './perplexity.js';
...
export class SlashCommandRegistry {
  ...
  static {
    ...
    const perplexity = new PerplexitySlashCommandConfigurator();
    ...
    this.configurators.set(perplexity.toolId, perplexity);
  }
