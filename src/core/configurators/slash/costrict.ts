...
const FILE_PATHS = {
  proposal: '.cospec/openspec/commands/lightspec-proposal.md',
  apply: '.cospec/openspec/commands/lightspec-apply.md',
  archive: '.cospec/openspec/commands/lightspec-archive.md',
