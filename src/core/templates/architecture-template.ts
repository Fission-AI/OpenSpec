 ...
 *
 * Template for generating architecture.md - a living document that captures
 * system architecture, components, data flows, and architectural decisions.
 */

export const architectureTemplate = `# System Architecture
