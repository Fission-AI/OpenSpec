...
export function getFfChangeSkillTemplate(): SkillTemplate {
  return {
    name: 'pastelsdd-ff-change',
    description: 'Fast-forward through Pastelsdd artifact creation. Use when the user wants to quickly create all artifacts needed for implementation without stepping through each one individually.',
