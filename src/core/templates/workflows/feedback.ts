...
export function getFeedbackSkillTemplate(): SkillTemplate {
  return {
    name: 'feedback',
    description: 'Collect and submit user feedback about Pastelsdd with context enrichment and anonymization.',
    instructions: `Help the user submit feedback about Pastelsdd.
...
5. **Submit on confirmation**
   - Use the \`pastelsdd feedback\` command to submit
   - Format: \`pastelsdd feedback "title" --body "body content"\`
