...
export function getFeedbackSkillTemplate(): SkillTemplate {
  return {
    name: 'feedback',
    description: 'Collect and submit user feedback about ClearSpec with context enrichment and anonymization.',
    instructions: `Help the user submit feedback about ClearSpec.
...
5. **Submit on confirmation**
   - Use the \`clearspec feedback\` command to submit
   - Format: \`clearspec feedback "title" --body "body content"\`
